                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/distributor/new') }}"><i class="fas fa-plus"></i> Create</a>
                                </li>
                                <li class="nav-item">
                ...
                @component('components.table', ['data' => $data, 'props' => []])
                    ...
                    @scopedslot('record', ($item, $props))
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group">
                                    <a href="{{ url('/distributor/edit/'.$item->id) }}" class="btn btn-success btn-xs">Edit</a>
                                ...
                                <div class="btn-group" style="margin-top: 10px;">
                                    <a href="{{ url('/distributor/edit_harga/'.$item->id) }}" class="btn btn-warning btn-xs">Edit Harga</a>
                                </div>
                            </td>
                        </tr>
                    @endscopedslot
...
@section('script')
    @include('app.distributor.home.scripts.index')
@endsection
