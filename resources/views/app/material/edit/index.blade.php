                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="editMailClassificationForm">
                            ...
                            <div class="form-group form-group-default required ">
                                ...
                                <input name="alias_name" value="{{ $data['alias_name'] }}" class="form-control" type="text" required>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-3">
                <div class="card card-default card-action">
                    <div class="card-body">
                        ...
                        <a href="{{ UrlPrevious(url('/material')) }}" class="btn btn-block btn-primary btn-cons m-b-10">
...
@section('formValidationScript')
    @include('app.material.edit.scripts.form')
@endsection
