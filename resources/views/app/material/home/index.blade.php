                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/material/new') }}"><i class="fas fa-plus"></i> Create</a>
                                </li>
                                <li class="nav-item">
                ...
                @component('components.table', ['data' => $data, 'props' => []])
                    ...
                    @scopedslot('record', ($item, $props))
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group">
                                    <a href="{{ url('/material/edit/'.$item->id) }}" class="btn btn-success btn-xs">Edit</a>
...
@section('script')
    @include('app.material.home.scripts.index')
@endsection
