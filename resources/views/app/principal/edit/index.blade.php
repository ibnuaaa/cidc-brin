                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="editMailClassificationForm">
                            ...
                            <div class="form-group form-group-default required ">
                                ...
                                <input name="nomor_akta_pendirian_perusahaan" value="{{ $data['nomor_akta_pendirian_perusahaan'] }}" class="form-control" type="text" required>
                            </div>
                            <div class="form-group form-group-default required ">
                                <label>Tanggal Akta Pendirian Perusahaan</label>
                                <input name="tanggal_akta_pendirian_perusahaan" value="{{ $data['tanggal_akta_pendirian_perusahaan'] }}" id="datepicker" class="form-control" type="text" required>
                            </div>
                            <div class="form-group form-group-default required ">
                                <label>Nomor Akta Perubahan Terakhir</label>
                                <input name="nomor_akta_perubahan_terakhir" value="{{ $data['nomor_akta_perubahan_terakhir'] }}" class="form-control" type="text" required>
                            </div>
                            <div class="form-group form-group-default required ">
                                <label>Tanggal Akta Perubahan Terakhir</label>
                                <input name="tanggal_akta_perubahan_terakhir" value="{{ $data['tanggal_akta_perubahan_terakhir'] }}" id="datepicker" class="form-control" type="text" required>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-3">
                <div class="card card-default card-action">
                    <div class="card-body">
                        ...
                        <a href="{{ UrlPrevious(url('/principal')) }}" class="btn btn-block btn-primary btn-cons m-b-10">
...
@section('formValidationScript')
    @include('app.principal.edit.scripts.form')
@endsection
